...
The Bitski Wallet is an unparalleled consumer wallet experience powering the next wave of mass adoption in Web3.
...
---
Try out our [iOS App](https://apps.apple.com/us/app/bitski-wallet/id1587199538) or [Browser Extension](https://chrome.google.com/webstore/detail/bitski/feejiigddaafeojfddjjlmfkabimkell) today to experience all of our features. Interested in seeing how we built these features and how you can too? Follow the links for the relevant API.

- [Check your cryptocurrency and NFT balances](/wallet-as-a-service/wallet-experience-apis/get-v2-balances)
- [Send and receive cryptocurrencies and NFTs](/wallet-as-a-service/wallet-experience-apis/get-v1-transactions)
- [Explore the decentralized web and track your on-chain activities](/wallet-as-a-service/wallet-experience-apis/get-v2-activity)
- [Monitor and receive notifications for all wallets via Watched Wallets](/wallet-as-a-service/wallet-experience-apis/activity-webhooks)
...
Install by adding the extension through the [Chrome Web
Store](https://chrome.google.com/webstore/detail/bitski/feejiigddaafeojfddjjlmfkabimkell).

<iframe width="560" height="315" src="https://www.youtube-nocookie.com/embed/AKjYmvRhJ0w" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
---

## iOS App

Install the iOS app via the App Store.

[![Apple App Store Download](/assets/images/app-store-download.svg)](https://apps.apple.com/us/app/bitski-wallet/id1587199538)

<iframe width="560" height="315" src="https://www.youtube-nocookie.com/embed/MHB022CntXw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
---
