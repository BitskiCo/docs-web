...
<Warning>
  ...
  credentials. Send an e-mail to sales@bitski.com containing your app ID and
  credentials client ID if you'd like to use them.
</Warning>
...
check with support either via sales@bitski.com or on the Bitski Discord
server.
