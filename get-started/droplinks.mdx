...
Droplinks allow you to create single or multi-use codes that can be redeemed for
an NFT. It works across devices, i.e. mobile and web, and can generate unlimited
codes for an NFT. Droplinks makes it easy to build a first-class token
...
On [bitski.com](https://www.bitski.com) we have hidden a multi-link
[Droplink](https://www.bitski.com/claim/6bb52d05-e502-4f2b-8302-800600617692).
Simply click on it and you get redirected to a page like the image below, where
by clicking the "Claim now" button you get an NFT minted to your wallet. It's
that easy!
