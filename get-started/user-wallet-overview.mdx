...
We use OAuth to provide access to a user's wallet. Through our SDK, your app can request access to a user's Bitski account. If Bitski grants access permission, your app can then use standard tools like web3.js to interact with the Ethereum network. Learn more in [Get Started](/get-started/getting-started-user-wallet).