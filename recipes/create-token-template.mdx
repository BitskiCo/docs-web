...
Set your [auth token](/reference/authentication), your application id, and your contract ID.
...
<Info>Configure a token template which will be used a base for your NFTs. See [create token template](/reference/create-token-template) for all available options</Info>
