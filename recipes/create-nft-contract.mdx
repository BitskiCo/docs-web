...
Set your [auth token](/reference/authentication) and your application id.
...
- all the others are optional, see [Create a contract](create-a-contract) reference for more detail.
