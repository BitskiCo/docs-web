...
description: "PATCH /v1/apps/{appId}/fulfillments/{fulfillmentId}"
---

<Note>Access to this API is available upon request to sales@bitski.com.</Note>

Update a given fulfillment status to complete.
...
```bash Request
curl -X 'PATCH' \
  'https://api.bitski.com/v1/apps/<APP_ID>/fulfillments/<FULFILLMENT_ID>' \
