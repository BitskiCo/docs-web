...
description: "Get details about a droplink."
---

<ParamField path="id" type="string" default="bcc5d460-bec9-43ad-952a-9641514a6e7b" required>
...
<ResponseField name="claimCodeThemes" type="array of objects" required>
  <Expandable title="properties">
    <ResponseField name="id" type="string" required/>
