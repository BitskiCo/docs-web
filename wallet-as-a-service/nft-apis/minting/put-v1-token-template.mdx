---
title: "PUT Token Template"
api: "PUT https://api.bitski.com/v1/apps/{appId}/token-templates/{tokenTemplateId}"
authMethod: "bearer"
...
```bash cURL
curl -X 'PUT' \
  'https://api.bitski.com/v1/apps/{appId}/token-templates/{tokenTemplateId}' \
