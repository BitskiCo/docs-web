...
api: "POST https://api.bitski.com/v1/transactions"
description: "Create a new pending transaction for the current user."
authMethod: "bearer"

---

<Note>Access to this API requires authentication. To receive help on accessing this API, please reach out to sales@bitski.com.</Note>

Users can be prompted to sign your transaction after creation. Email us or join
the discord for help creating transactions.

```javascript Redirect after creation
...
![Transactions](/assets/images/transactions-d5e3645ce6459977526ac454fea48a92.png)
