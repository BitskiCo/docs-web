...
<Card title="ethers.js" icon="hexagon-image" color="#4FA936" href="https://github.com/BitskiCo/bitski-js/tree/main/examples/ethers">
  See an example of Bitski + ethers.js. This approach is recommended if you prefer to use JSON RPC Methods via the ethers providers `send` function. 
</Card>
<Card title="web3.js" icon="chart-network" color="#4FA936" href="https://github.com/BitskiCo/bitski-js/tree/main/examples/web3js">
  See an example of Bitski + web3.js. This approach is recommended if you prefer have JSON RPC Methods abstracted via function calls.
</Card>
<Card title="viem" icon="rocket" color="#4FA936" href="https://github.com/BitskiCo/bitski-js/tree/main/examples/viem">
  See an example of Bitski + viem. This approach is recommended if you prefer Typescript-safe and more opinionated framework of working with Web3 calls.
</Card>
